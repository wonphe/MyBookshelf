...
public class LauncherIcon {
    ...
    private static ComponentName componentNameMain = new ComponentName(MApplication.getInstance(), "top.ox16.yuedu.view.activity.WelcomeActivity");
    private static ComponentName componentNameBookMain = new ComponentName(MApplication.getInstance(), "top.ox16.yuedu.view.activity.WelcomeBookActivity");
